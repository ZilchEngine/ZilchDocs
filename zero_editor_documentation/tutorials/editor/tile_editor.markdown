This lesson covers the basics of Zero Engine's Tile Editor tool. The [ next lesson](https://github.com/ZilchEngine/ZilchDocs/blob/master/zero_editor_documentation/tutorials/editor/tile_editor_ii.markdown) covers some of its more advanced features.
...
- Download the following tile sheet:
  ![PlatformerTiles](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/107599.png)
...
- In the `Library Window`
 - Under the SpriteSource  tag
  - Double-click  `PlatformerTiles`
    ![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/107617.png)
...
![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/107673.png)
...
![Adding Grass Tile Frames](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/109080.gif)
...
(NOTE) **FrameRate:** The FrameRate  property defines the number of animation frames per second for an animated sprite source. (In other words, 1 divided by FrameRate  equals the delay in seconds for each frame.) The lava animation with a FrameRate  of `12` looks like this: ![Animated Lava Surface at 83 ms Delay](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/109076.gif) ; the same animation with a FrameRate  of 4 looks like this: ![Animated Lava Surface at 250 ms Delay](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108754.gif) .



![Adding Lava Surface](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/109083.gif)
...
- In the `Tool Bar`
  ![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108716.png)
 - Press the ![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/107930.png) {nav icon=square-o, name=TileEditor2D} button

(NOTE) **Tool Control Info:** For quick reminders about the controls of the TileEditor2D tool, just hover  over the ![Circled Info Icon](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108711.png) icon in the upper-left corner of the `Tools Window`.

Selecting the TileEditor2D tool for the first time will show this:



![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/107932.png)
...
- In the `Level Window`
 - Click  the **No TileMap Object** message
   ![Adding a TileMap Object](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/107934.gif)
...
- In the `Tools Window`
 - Set Sprite enum to the SpriteSource of your choice
   ![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108232.png)
- In the `Level Window`
 - `Left-click and drag` to **place tiles**
   ![First Steps - Drawing](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108230.gif)
 - `Right-click and drag` to **erase tiles**
   ![First Steps - Erasing](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108234.gif)
...
- In the `Tools Window`
 - Set ToolType enum to [ SelectionTool](https://github.com/ZilchEngine/ZilchDocs/blob/master/code_reference/enum_reference.markdown#tileeditor2dsubtooltype)
   ![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108285.png)
...
- In the `Level Window`
 ...
 - If you don't want to use the selected tiles as a brush, right-click  somewhere else in the `Level Window` to **clear the selection**
   ![First Steps - Selecting](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108316.gif)
...
- In the `Level Window`
 ...
 - `Right-click and drag` to **erase tiles with the new brush**
   ![First Steps - Brush Painting](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108320.gif)
...
- Use the TileEditor2D tool to create a set of simple platforms:
  ![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108816.png)
- Press the ![image](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108714.png) Market button button in the top-right corner of the editor
...
- In the `Library Window`
 - Under Archetype 
  - `Left-click and drag` `SweptPlayer2D` into the `Level Window`
    ![Adding a Swept Character](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108718.gif)
...
![This Swept Character Cannot Jump High Enough](https://media.githubusercontent.com/media/ZilchEngine/ZilchFiles/master/doc_files/108720.gif)
