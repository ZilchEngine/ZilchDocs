Nada comes with a set of templates/macros that allow your C++ classes and functions to be called by Nada code. We recommend that you read up on the LibraryBuilder documentation first. Internally, the macros simply create a LibraryBuilder and automatically add BoundTypes, Properties, and Functions to it.
...
The following list is not exhaustive, but contains the most common types that we accept in binding automatically. Technically anything defined in Nada.hpp that either internal or external binding and is bound to the Core library can be used. Note that most primitives (int, float, etc) are simply type-defined as Integer, Real, etc and can be used in binding.
 ...
 - [ Boolean](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Boolean2](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Boolean3](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Boolean4](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Byte](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Integer](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Integer2](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Integer3](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Integer4](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Real](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Real2](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Real3](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Real4](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Quaternion](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ String](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ DoubleReal](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ DoubleInteger](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [ Handle](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown) (binds to a special type that can accept any handle to any object type)
 - [ Delegate](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown) (binds to a special type that can accept any delegate)
 - [ Any](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown) (can accept any type in Nada)
 - [ StringBuilderExtended](https://github.com/ZilchEngine/ZilchDocs/blob/master.markdown)
 - [[ | ArrayClass<Handle>]]
 - [[ | ArrayClass<Delegate>]]
 - [[ | ArrayClass<Boolean>]]
 - [[ | ArrayClass<Boolean2>]]
