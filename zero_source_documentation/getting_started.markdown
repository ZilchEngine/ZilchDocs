Before diving into Zero Source, it is important to become familiar with Zero itself as a game engine. Please visit [getting_started](https://github.com/ZilchEngine/ZilchDocs/blob/master/getting_started.markdown).
