...
All of these eases can be visualized on a graph. In Zilch, graphs like this may be plotted on a [SampleCurve](https://github.com/ZilchEngine/ZilchDocs/blob/master/zilch_editor_documentation/zilchmanual/architecture/resources/samplecurve.markdown), allowing their use as the ease parameter in Actions.
